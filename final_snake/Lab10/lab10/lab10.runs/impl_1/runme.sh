...
HD_PWD='D:/NYCU/113-1/DCD Lab/Final Project/lab10_for_student/Lab10/lab10/lab10.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log walk.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source walk.tcl -notrace
