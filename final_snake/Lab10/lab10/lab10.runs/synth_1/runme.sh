...
HD_PWD='D:/NYCU/113-1/DCD Lab/Final Project/lab10_for_student/Lab10/lab10/lab10.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log walk.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source walk.tcl
