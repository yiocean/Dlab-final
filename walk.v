...
module walk(
    ...
    input  [3:0] usr_sw,
    output [3:0] usr_led,
//    output [8:0] snake_x_o,
//    output [8:0] snake_y_o,
...
sram #(.DATA_WIDTH(12), .ADDR_WIDTH(18), .RAM_SIZE(BUF_W_1*BUF_H_1), .FILE("game_bg.mem"))
...
reg [1:0] Q;
wire [1:0] level = 2'b11; // 01,10,11
always@(posedge clk) begin
    if(~reset_n) begin // TODO: add if next level
        Q <= S_RIGHT;
        snake_x[0] <= 50;
        snake_x[1] <= 45;
        snake_x[2] <= 40;
